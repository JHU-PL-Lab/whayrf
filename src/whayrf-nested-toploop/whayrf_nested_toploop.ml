...
let toploop_operate e =
  ...
  begin
    try
      let e' = a_translate_whayrf_nested_expr e in
...
let () =
  print_string "Whayrf Nested Toploop\n";
  print_string "--------------------\n";
  print_string "\n";
  print_string "Please enter an expression to evaluate followed by \";;\".\n";
  print_string "\n";
  flush stdout;
  Whayrf_nested_parser.parse_whayrf_expressions IO.stdin
